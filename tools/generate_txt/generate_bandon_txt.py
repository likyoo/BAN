...
def generate_txt_from_dir(src_dir, dst_dir, split):
    ...
    """
    label_subdir_name = 'labels' if split == 'val' \
        else 'labels_unch0ch1ig255'
...
def main():
    ...
    generate_txt_from_dir(dataset_path, out_dir, 'test/test')
    generate_txt_from_dir(dataset_path, out_dir, 'test/test_ood')
